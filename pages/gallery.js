      ...
      <div className={utilStyles.galleryWrapper}>
        ...
        <motion.div transition={{ duration: 1.7 }} animate='animate' exit='exit' initial='initial' variants={cardAnimations} className={utilStyles.gallery}>
          ...
          <motion.div variants={cards} className={utilStyles.galleryGroup}>
            <Image priority layout='fill' objectfit="cover" className={utilStyles.galleryImages} src='https://img1.wsimg.com/isteam/ip/15b1b8e3-2dc8-4905-bc55-7e810b2a928f/df933c83-c5e1-4c29-b701-864d40905bd7.jpg/:/rs=w:1300px,h:800px' alt='solar house'></Image>
