          ...
          <div className={utilStyles.innerHomeTopRight}>
            <div className={utilStyles.innerHomeTopRightContent}>
              ...
              <motion.div className={utilStyles.solarShapeBG} initial={{ x: 1000 }} animate={{ x: 0 }} exit={{ x: 1000 }} transition={{ ease: [0.6, 0.01, -0.05, 0.9], delay: 0, duration: 1.6 }}></motion.div>
                <div className={utilStyles.solarHeadingPop}><motion.h1 initial={{ x: -3000, opacity: 1, filter: "blur(20px)" }} exit={{ x: -3000, opacity: 1, filter: "blur(20px)" }} animate={{ x: 0, opacity: 1, filter: "blur(0px)" }} transition={{ ease: [0.6, 0.01, -0.05, 0.9], delay: 0.12, duration: 2.6 }}>Eco Sales & Services Ltd.</motion.h1></div>
                <div className={utilStyles.solarInfoPop}><motion.p initial={{ x: 3000, opacity: 1, filter: "blur(10px)" }} exit={{ x: 3000, opacity: 1, filter: "blur(10px)" }} animate={{ x: 0, opacity: 1, filter: "blur(0px)" }} transition={{ ease: [0.6, 0.01, -0.05, 0.9], delay: 0.12, duration: 2.9 }}>A local friendly renewable energy company giving nationwide renewable energy management solutions.</motion.p></div>
                <div className={utilStyles.solarInfoTel}><motion.p initial={{ x: 3000, opacity: 1, filter: "blur(10px)" }} exit={{ x: 3000, opacity: 1, filter: "blur(10px)" }} animate={{ x: 0, opacity: 1, filter: "blur(0px)" }} transition={{ ease: [0.6, 0.01, -0.05, 0.9], delay: 0.08, duration: 2.3 }}>TEL: 01782 256805</motion.p></div>
