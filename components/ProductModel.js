                ...
                <>
                    <motion.div id="modalBG" onClick={(e) => {
                        ...
                        <motion.div animate="animate" initial="initial" exit="exit" variants={modalVarients} layoutId='background' className={utilStyles.modalProducts} transition={modalTransition}>
                            <motion.div animate={{ scale: 1 }} initial={{ scale: 0 }} exit={{ scale: 0, transition: { delay: 0, duration: 0 } }} transition={{ delay: 0.39 }} onClick={() => setShowModal(!showModal)} className={utilStyles.fabFlip}>
                            ...
                            <motion.div animate={{ scale: 1 }} initial={{ scale: 0 }} exit={{ scale: 0, transition: { delay: 0, duration: 0 } }} transition={{ delay: 0.39 }} onClick={() => setShowModal(!showModal)} className={utilStyles.fabFlipButton}>
